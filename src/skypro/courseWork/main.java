...
public class main {
    public static void main(String[] args) {
        ...
        Employee[] employeeCount = new Employee[10];
        employeeCount[0] = new Employee("Архипов Гордий Павлович", 1, 64900);
        employeeCount[1] = new Employee("Соловьёв Федор Игоревич", 2, 80903);
        employeeCount[2] = new Employee("Копылов Аполлон Авксентьевич", 3, 81128);
        employeeCount[3] = new Employee("Королёв Ефим Тимофеевич", 4, 90535);
        employeeCount[4] = new Employee("Авдеев Руслан Витальевич", 5, 90725);
        employeeCount[5] = new Employee("Иванова Наталия Сергеевна", 1, 75586);
        employeeCount[6] = new Employee("Кондратьева Неонила Вячеславовна", 2, 65770);
